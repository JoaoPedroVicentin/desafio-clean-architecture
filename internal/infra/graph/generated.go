...
import (
	...
	"github.com/JoaoPedroVicentin/desafio-clean-architecture/internal/infra/graph/model"
...
func (ec *executionContext) field_Mutation_createOrder_argsInput(
	...
	if tmp, ok := rawArgs["input"]; ok {
		return ec.unmarshalNOrderInput2githubᚗcomᚋJoaoPedroVicentinᚋdesafioᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput(ctx, tmp)
	}
...
func (ec *executionContext) _Mutation_createOrder(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNOrder2ᚖgithubᚗcomᚋJoaoPedroVicentinᚋdesafioᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_orders(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Order)
	fc.Result = res
	return ec.marshalNOrder2ᚕᚖgithubᚗcomᚋJoaoPedroVicentinᚋdesafioᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNOrder2githubᚗcomᚋJoaoPedroVicentinᚋdesafioᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v model.Order) graphql.Marshaler {
	return ec._Order(ctx, sel, &v)
}

func (ec *executionContext) marshalNOrder2ᚕᚖgithubᚗcomᚋJoaoPedroVicentinᚋdesafioᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Order) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNOrder2ᚖgithubᚗcomᚋJoaoPedroVicentinᚋdesafioᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNOrder2ᚖgithubᚗcomᚋJoaoPedroVicentinᚋdesafioᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrder(ctx context.Context, sel ast.SelectionSet, v *model.Order) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNOrderInput2githubᚗcomᚋJoaoPedroVicentinᚋdesafioᚑcleanᚑarchitectureᚋinternalᚋinfraᚋgraphᚋmodelᚐOrderInput(ctx context.Context, v interface{}) (model.OrderInput, error) {
